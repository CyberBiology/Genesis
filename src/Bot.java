...
//...............  сменить направление относительно   ....
                case 23:                            // вычисляем новое направление
                    param = botGetParam(this) % 8;          // берём следующи байт за командой и вычисляем остаток от деления на 8
...
//...............  сменить направление абсолютно   ....
                case 24:                // записываем новое значение направления
...
//.............   посмотреть в абсолютном направлении ...............
                case 31: // пусто - 2 стена - 3 органик - 4 бот -5 родня -  6
                    drct = botGetParam(this) % 8;
...
//.............   делится   в относительном напралении  ........................
                case 32:
                case 33:    // увеличил шансы появления этой команды
                    drct = botGetParam(this) % 8;    // вычисляем направление из следующего за командой байта
...
//...................  какой мой уровень (на какой высоте бот)  .........?????????????????????????????????????????????????????????????????
                case 41:   // у меня поле высотой в 96 клеток
                    // байт в геноме может иметь значение от 0 до 63
                    // умножая значение байта на 1,5 получаем значение от 0 до 95
                    param = botGetParam(this) * World.simulation.height / MIND_SIZE;   // берем следующий за командой байт и умножаем на 1,5
...
//**************************************************************************
//...................  какое моё здоровье  ...............................
                case 42:   // максимальное здоровье  999
                    // байт в геноме может иметь значение от 0 до 63
                    // умножая значение байта на 15 получаем значение от 0 до 945
                    param = botGetParam(this) * 1000 / MIND_SIZE;   // берем следующий за командой байт и умножаем на 15
...
//...................сколько  минералов ...............................
                case 43:
                    param = botGetParam(this) * 1000 / MIND_SIZE;
                    if (mineral < param) {
                        botIndirectIncCmdAddress(this, 2);
                    } else {
                        botIndirectIncCmdAddress(this, 3);
...
//.......  пришло время подохнуть или породить потомка              ........
    ...
    private int botGetParam(Bot bot) {
        ...
        if (paramadr >= MIND_SIZE) paramadr = paramadr - MIND_SIZE;
